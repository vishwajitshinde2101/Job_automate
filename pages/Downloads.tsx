...
import { Download, MonitorPlay, CheckCircle2, ArrowRight } from 'lucide-react';
...
const Downloads: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>Download AutoJobzy - Desktop App for Windows</title>
        <meta name="description" content="Download AutoJobzy desktop application for Windows. Free job automation tool." />
      </Helmet>
      ...
      <main className="min-h-screen bg-gradient-to-b from-dark-900 via-black to-dark-900 pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
            ...
            <div className="group relative bg-gradient-to-br from-dark-800 to-dark-900 rounded-2xl p-8 border-2 border-cyan-500/30 hover:border-cyan-500/60 transition-all duration-300 overflow-hidden max-w-2xl">
              ...
              <div className="relative z-10">
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-gray-300">
                    <CheckCircle2 className="w-4 h-4 text-neon-green" />
                    <span className="text-sm">Easy one-click installer (.exe)</span>
                  </div>
                  <div className="flex items-center gap-2 text-gray-300">
                    <CheckCircle2 className="w-4 h-4 text-neon-green" />
                    <span className="text-sm">64-bit compatible</span>
                  </div>
                </div>
          ...
          <motion.section
            ...
            className="mb-12"
          >
            <div className="bg-dark-800 rounded-xl p-6 border border-white/10 max-w-2xl">
              ...
              <ol className="space-y-3 text-gray-300 text-sm">
                ...
                <li className="flex gap-3">
                  ...
                  <span>Double-click the installer to run it</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span>Click "More info" → "Run anyway" if Windows Defender shows a warning</span>
                </li>
                <li className="flex gap-3">
                  ...
                  <span>Follow the installation wizard and launch AutoJobzy</span>
                </li>
                <li className="flex gap-3">
          ...
          <motion.section
            ...
            className="mt-4 bg-gradient-to-r from-neon-blue/10 to-neon-purple/10 rounded-2xl p-8 border border-white/10"
          >
