...
import AdvancedPlanTeaser from '../components/AdvancedPlanTeaser';
...
const Landing: React.FC = () => {
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-r from-neon-purple via-neon-blue to-neon-purple py-1 animate-gradient-x">
