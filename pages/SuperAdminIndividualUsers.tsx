...
const SuperAdminIndividualUsers: React.FC = () => {
  ...
  const handleResetPassword = async () => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/superadmin/users/${resetPasswordUser!.id}/reset-password`, {
        method: 'POST',
        headers: {
      ...
      setResetSuccess(`Password reset successfully for ${resetPasswordUser!.email}`);
      setResetNewPassword('');
      ...
      <div className="min-h-screen bg-dark-900">
                    ...
                    <tr key={user.id} className="hover:bg-dark-700 transition-colors">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() => { setResetPasswordUser(user); setResetError(''); setResetSuccess(''); }}
                            className="px-3 py-1.5 bg-orange-500/10 border border-orange-500/30 text-orange-400 rounded-lg hover:bg-orange-500/20 transition-colors text-sm flex items-center gap-2"
                          >
        ...
        {resetPasswordUser && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
            <div className="bg-dark-800 border border-white/10 rounded-2xl max-w-md w-full shadow-2xl">
              ...
              <div className="p-6 border-b border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5 truncate max-w-[220px]">{resetPasswordUser.email}</p>
                  </div>
                </div>
                <button onClick={closeResetModal} className="p-2 hover:bg-dark-700 rounded-lg transition-colors">
                ...
                <div className="bg-dark-900 rounded-lg p-3 flex items-center gap-3">
                  <div className="w-9 h-9 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full flex items-center justify-center flex-shrink-0">
                    <span className="text-white font-bold text-sm">
                      {resetPasswordUser.firstName?.charAt(0)}{resetPasswordUser.lastName?.charAt(0)}
                    </span>
                  </div>
                  <div>
                    <p className="text-white font-medium text-sm">{resetPasswordUser.firstName} {resetPasswordUser.lastName}</p>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-dark-900 border border-gray-700 rounded-lg py-2.5 pl-9 pr-10 text-white focus:border-orange-400 focus:ring-1 focus:ring-orange-400 outline-none transition-all text-sm"
              ...
              <div className="p-6 border-t border-white/10 flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-dark-900 border border-white/10 text-white rounded-lg hover:bg-dark-700 transition-colors text-sm"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 px-4 py-2.5 bg-orange-500 text-white font-bold rounded-lg hover:bg-orange-400 transition-colors flex items-center justify-center gap-2 text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {resetLoading ? (
