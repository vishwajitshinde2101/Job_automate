/**
 * Create tables without foreign keys to avoid constraint conflicts
 */
...
async function createTables() {
    try {
        ...
        // Create job_settings table WITHOUT foreign key
        ...
        // Create job_application_results table WITHOUT foreign key
        ...
        `);
        console.log('✅ user_filters created\n');
        ...
        `);
        console.log('✅ user_plans created\n');
        ...
        console.log('\nℹ️  Foreign key constraints omitted to avoid RDS restrictions');
        console.log('   Application enforces referential integrity through Sequelize');
